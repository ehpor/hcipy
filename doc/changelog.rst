...
* Added the LUVOIR-B, GMT, TMT, Hale, HabEx, Hubble and JWST telescope apertures (`@ivalaginja <https://github.com/ivalaginja>`__, `@syhaffert <https://github.com/syhaffert>`__ & `@ehpor <https://github.com/ehpor>`__)
...
* Allow single-mode fibers to be put at arbitrary positions (`@syhaffert <https://github.com/syhaffert>`__)
