...
def pyramid_wavefront_sensor(pupil_grid, pupil_diameter, pupil_separation, num_pupil_pixels, q, wavelength, refractive_index, num_airy=None):
	# Make mask
...
def zernike_wavefront_sensor(pupil_grid, pupil_diameter, num_pupil_pixels, q, wavelength_0, diameter, num_airy=None):
	...
	return FourierWavefrontSensor(pupil_grid, focal_plane_mask, output_grid_size, output_grid_pixels, q, wavelength_0, num_airy)
...
def optical_differentiation_wavefront_sensor(amplitude_filter, pupil_grid, pupil_diameter, pupil_separation, num_pupil_pixels, q, wavelength_0, refractive_index, num_airy=None):
	# Make mask
	sep = 0.5 * pupil_separation * pupil_diameter
...
def rooftop_wavefront_sensor(pupil_grid, pupil_diameter, pupil_separation, num_pupil_pixels, q, wavelength_0, refractive_index, num_airy=None):
	amplitude_filter = lambda x : (x<0)/np.sqrt(2)
	return optical_differentiation_wavefront_sensor(amplitude_filter, pupil_grid, pupil_diameter, pupil_separation, num_pupil_pixels, q, wavelength_0, refractive_index, num_airy)

def gOD_wavefront_sensor(beta, pupil_grid, pupil_diameter, pupil_separation, num_pupil_pixels, q, wavelength_0, refractive_index, num_airy=None):
	amplitude_filter = lambda x : ((x>0) * beta + (1 - beta)*(1+x)/2)/np.sqrt(2)
	return optical_differentiation_wavefront_sensor(amplitude_filter, pupil_grid, pupil_diameter, pupil_separation, num_pupil_pixels, q, wavelength_0, refractive_index, num_airy)

def pol_gOD_wavefront_sensor(beta, pupil_grid, pupil_diameter, pupil_separation, num_pupil_pixels, q, wavelength_0, refractive_index, num_airy=None):
